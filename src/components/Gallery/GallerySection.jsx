  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Text fontFamily="mono" fontSize="9px" color="brand.doradoLight"
            textTransform="uppercase" letterSpacing="0.22em">
            {photo.category}
          </Text>
          <Text fontFamily="heading" fontSize={{ base: 'lg', md: 'xl' }} color="brand.bone"
            lineHeight={1.1} mt={1}>
            {photo.caption}
          </Text>
        </Box>
...
export default function GallerySection() {
  ...
  const total      = coachData.gallery.length
  ...
  return (
    ...
    >
      ...
      <Box
        ...
        background="radial-gradient(ellipse, rgba(196,30,42,0.14) 0%, transparent 70%)"
        pointerEvents="none"
      />
      ...
      >
        ...
        <Box position="absolute" left={0} top={0} bottom={0} w={{ base: '8%', lg: '14%' }}
             bgGradient="linear(to-r, brand.negro, transparent)" zIndex={30} pointerEvents="none" />
        <Box position="absolute" right={0} top={0} bottom={0} w={{ base: '8%', lg: '14%' }}
             bgGradient="linear(to-l, brand.negro, transparent)" zIndex={30} pointerEvents="none" />
      </Box>
            ...
            {coachData.gallery.map((photo, i) => {
              ...
              return (
                <Box
                  ...
                  position="relative"
                  border="1px solid"
                  borderColor={active ? 'brand.rojo' : 'whiteAlpha.200'}
                  boxShadow={active ? '0 0 0 2px rgba(196,30,42,0.4)' : 'none'}
      ...
      <AnimatePresence>
        {lightbox !== null && (
          <Lightbox
            photo={coachData.gallery[lightbox]}
