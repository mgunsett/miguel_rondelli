...
export function ContactSection() {
  const professional = coachData.contact.filter(
    (c) => c.title === 'Representante Deportivo'
  )
  const representative = coachData.contact.filter(
    ...
    >
      ...
      <Box position="relative" zIndex={1} maxW="1400px" mx="auto">
        ...
        <Box ref={headerRef} mb={{ base: 8, md: 10 }}>
          <Text fontFamily="mono" fontSize="10px" color="brand.boneWarm" letterSpacing="0.28em"
